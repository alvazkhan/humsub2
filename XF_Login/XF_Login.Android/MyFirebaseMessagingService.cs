...
namespace XF_Login.Droid
{
    ...
    [Android.App.IntentFilter(new[] { "com.google.firebase.INSTANCE_ID_EVENT" })]
    public class MyFirebaseMessagingService : FirebaseMessagingService
    {
        ...
        void SendNotification(string messageBody)
        {
            ...
            var pendingIntent = Android.App.PendingIntent.GetActivity(this, 0, intent, Android.App.PendingIntentFlags.OneShot);
